      ...
      <Router future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
        <Routes>
          ...
          <Route path="/view-tools" element={
            <ProtectedRoute><ViewTools /></ProtectedRoute>
          } />
          <Route path="/add-tool" element={
            <ProtectedRoute requiredRole="admin"><AddEditTool /></ProtectedRoute>
          } />
          <Route path="/manage-tools" element={
            <ProtectedRoute requiredRole="admin"><ManageTools /></ProtectedRoute>
          } />
